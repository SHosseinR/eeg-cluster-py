...
STIMULATION_DURATION_BOUNDS = (0.2, 2.0)
STIMULATION_AMPLITUDE_BOUNDS = (0.2, 2.0)
...
OPTIMIZATION_OUTPUT_DIR = 'results-ADHD-kaggle/optimization-nsga-new-correct'
OPTIMIZATION_RESULTS_FILE = 'optimization_results.npy'
OPTIMIZATION_FIGURES_DIR = 'results-ADHD-kaggle/optimization-nsga-new-correct/figures'
